...
export function updateGameBoard(board) {
    ...
    boardData.forEach((row, rowIndex) => {
        ...
        row.forEach((cell, colIndex) => {
            ...
            if (rowIndex % 3 === 0) cellDiv.classList.add('border-top');
            if (rowIndex === 8) cellDiv.classList.add('border-bottom');
            if (colIndex % 3 === 0) cellDiv.classList.add('border-left');
            if (colIndex === 8) cellDiv.classList.add('border-right');
