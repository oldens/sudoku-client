...
/**
 * Start a new game
 * @returns {Promise} Resolves with the game data if the game is successfully started, otherwise rejects with an error message.
 */
export async function startNewGame() {
    try {
        ...
        await set(ref(db, 'game/active'), gameData);
